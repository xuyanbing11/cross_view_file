...
def evaluate(qf_street, ql_street, qf_drone, ql_drone, gf, gl):
    ...
    for label in unique_labels:
        ...
        # fused_feature = avg_street_features##单独的街道
        # fused_feature = avg_drone_feature####单独的无人机
        # 计算余弦相似度
...
# print(f"now is {num_drone}drone and {num_street}street")  
print('Recall@1:%.2f Recall@5:%.2f Recall@10:%.2f Recall@top1:%.2f AP:%.2f' % (CMC[0] * 100, CMC[4] * 100, CMC[9] * 100,CMC[round(len(gallery_label) * 0.01)] * 100, ap * 100))
